\begin{table}[!ht]
  ...
  \scalebox{0.670000}{
    \begin{tabular}{| r | >{\raggedleft\arraybackslash}p{1.5cm} | >{\raggedleft\arraybackslash}p{1.5cm} | >{\raggedleft\arraybackslash}p{1.5cm} | >{\raggedleft\arraybackslash}p{1.5cm} | >{\raggedleft\arraybackslash}p{1.5cm} | >{\raggedleft\arraybackslash}p{1.5cm} |}
      ...
      \cline{02-07}
        %& \centering\textbf{~def~} & \centering\textbf{~tra\_br~} & \centering\textbf{~tra\_cg~} & \centering\textbf{~def~} & \centering\textbf{~tra\_br~} & \centering\textbf{~tra\_cg~} \\
	& \textbf{~def~} & \textbf{~tra\_br~} & \textbf{~tra\_cg~} & \textbf{~def~} & \textbf{~tra\_br~} & \textbf{~tra\_cg~} \\
      \hline
