...
%A complexidade deste problema ainda está em aberto, não conhecemos
%nenhuma prova que mostre que ele se encontra na classe dos problemas
%NP-Difícil e não existem evidências da existência de um algoritmo
%polinomial. O melhor algoritmo de aproximação conhecido possui razão
%de $1.375$ apresentado por Elias e Hartman \cite{EliasHartman*2006}.
