...
A subseção~\ref{subsec:rev_bkp} apresenta a definição de grafo
de \bkp{}, a subseção~\ref{subsec:cic_dec} descreve como se encontra
uma decomposição de ciclos no grafo de \bkp{} e a
subseção~\ref{subsec:rev_limitantes} descreve os limitantes usados
para o problema de ordenação por reversões.
...
\subsection{Decomposição de Ciclo}
\label{subsec:cic_dec}
