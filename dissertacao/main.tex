...
\def\fichacatalografica{
    \begin{center}
        \vspace{10cm} {\Large\bf\expandafter{Substitua pela ficha
            catalogr{\'a}fica}\\ {\rm (Esta p{\'a}gina deve ser o verso da
            p{\'a}gina anterior mesmo no\\ caso em que n{\~a}o se imprime
            frente e verso, i.e. at{\'e} 100 p{\'a}ginas.)}}
    \end{center}
}
