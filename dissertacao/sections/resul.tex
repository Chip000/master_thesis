...
%Para calcular a quantidade de ciclos ímpares no grafo de ciclos para
%transposições é mais simples do que encontrar o número de $2$-ciclos
%no grafo de \bkp{} para reversões.

%Como demostrado por Christie~\cite{Christie*1998}, para achar a
%quantidade de $2$-ciclos é necessário
