...
\label{sec:basic}
TODO: Conceitos Basicos sobre os problemas de ordenação por transposições,
ordenação por reversões e ordenação por reversões e transposições,
com a explicação dos limitantes e explicação básica sobre CP e ILP.
